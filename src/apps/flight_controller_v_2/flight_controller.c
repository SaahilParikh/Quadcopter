...
void fly() {
	...
	current_pwm[0] = (uint16_t) round(output_pwm[0]) + 121;
	current_pwm[1] = (uint16_t) round(output_pwm[1]) + 121;
	current_pwm[2] = (uint16_t) round(output_pwm[2]) + 121;
	current_pwm[3] = (uint16_t) round(output_pwm[3]) + 121;
